...
# Complexity
**Time:** O(1) - Both get and put operations use hashmap lookups and insertions/deletions, all constant time.
**Space:** O(n) - Where n is the capacity, storing entries in the key map and frequency buckets.
