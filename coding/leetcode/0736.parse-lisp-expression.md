...
# Complexity
**Time:** O(n^2) in the worst case where n is expression length (parsing and scope copying at each level)**Space:** O(n^2) for nested scope copies and recursion stack
