...
# Complexity
**Time:** O(m log n + m log m) - Sorting meetings takes O(m log m). Each meeting involves at most O(log n) heap operations.
**Space:** O(n + m) - Two heaps hold at most n rooms total, plus the count array.
