...
# Complexity
**Time:** O(n) - Topological pruning and BFS each visit every node and edge once.**Space:** O(n) - Adjacency list, degree array, and distance array all use linear space.
