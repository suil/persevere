...
# Complexity
**Time:** O(n^2) - Due to splice on the dry days array. Can be improved to O(n log n) with a sorted set.
**Space:** O(n) - For the full map, dry days array, and answer array.
