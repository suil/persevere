...
# Complexity
**Time:** O(n^2) - In the worst case, all transactions share the same name, requiring comparison of every pair.**Space:** O(n) - Space is used for the parsed transactions, the grouping map, and the set of invalid indices.
