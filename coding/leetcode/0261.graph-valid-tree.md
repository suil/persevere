...
**Space:** O(V + E) - adjacency list storage plus visited set and recursion stack

**Solution 2:**
**Time:** O(E * α(V)) - processes E edges with Union-Find operations that have nearly constant amortized time due to path compression
**Space:** O(V) - Union-Find data structure stores parent array of size V
